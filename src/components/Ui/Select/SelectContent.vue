...
import { SelectContent, SelectPortal, SelectViewport, useForwardProps } from "reka-ui"
...
const selectViewport = tv({
  ...
  variants: {
    position: {
      popper: "h-[var(--reka-select-trigger-height)] w-full min-w-[var(--reka-select-trigger-width)]",
      "item-aligned": "",
    },
  },
  defaultVariants: {
...
<template>
  <SelectPortal>
    <SelectContent
      ...
      v-bind="forwarded"
      :class="[selectContent({ position }), props.class]"
    >
